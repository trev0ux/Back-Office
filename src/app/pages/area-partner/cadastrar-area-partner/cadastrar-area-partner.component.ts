...
@Component({
  selector: 'app-cadastrar-area-partner',
  templateUrl: './cadastrar-area-partner.component.html',
  styleUrls: ['./cadastrar-area-partner.component.css']
})
export class CadastrarAreaPartnerComponent implements OnInit {
  ...
  constructor(private router: Router,
    ...
    private categoryService: AreaPartnerService,
  ...
  public save() {
    ...
    if (categoryModel._id) {
      this.categoryService.update(categoryModel).subscribe((data) => {
        console.log(data);
        this.router.navigate(['/area-partner']);
      }, error => {
