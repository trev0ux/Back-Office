...
@Component({
  selector: 'app-cadastrar-plano-servico',
  templateUrl: './cadastrar-plano-servico.component.html',
  styleUrls: ['./cadastrar-plano-servico.component.css']
})
export class CadastrarPlanoServicoComponent implements OnInit {
  errors: Array<string> = [];
  alerts: Alert[];
  ...
  public cancel() {
    this.router.navigate(['/club/produtos']);
  }
